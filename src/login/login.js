            ...
            <main className={classes.main}>
                ...
                <Paper className={classes.paper}>
                    ...
                    <form className={classes.form} onSubmit={(e) => this.submitLogin(e)} >
                        <FormControl required fullWidth magin="normal">
                            <InputLabel htmlFor="login-email-input">Enter your email</InputLabel>
                            <Input autoFocus autoComplete="email" id="login-email-input" onChange={(e) => this.userTyping("email", e)}></Input>
                        </FormControl>
                        <FormControl required fullWidth magin="normal">
                    ...
                    </form>
                    {
                        ...
                        <Typography component="h5" variant="h6" className={classes.errorText}>Incorrect login information</Typography>:
                        null
                    }
